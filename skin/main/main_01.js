$(function(){
    ...
    <div class="m_modal">
      <div class="m_map">
        ...
        <div class="modal_search">
          ...
          <input type="search" name="p_search" id="p_search" placeholder="제품명을 입력하세요 (해당 제품이 있는 약국을 검색합니다)">
          <i class="fas fa-magnifying-glass"></i>
        </div>
        <div class="modal_area">
          <label for="map_name">지역명 검색</label>
          <select name="map_name" id="map_name"></select>
          <select>
  ...
  $('i.fa-pause').click(function(){
    ...
    if(ms_i!==0){
      ...
      ms_i = 0; 
      $('.ms_btn > span').unbind('mouseenter mouseleave');
    }else{
      $('.ms_btn > span').hover(function(){
        clearInterval(Timer);
        return_a();
