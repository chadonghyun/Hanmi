...
<?php
  if(!isset($_SESSION['ss_mb_id'])) {
    echo "<script>alert('회원만 입장하실 수 있는 페이지입니다. 로그인 후 다시 입장해주세요.');location.replace('/index.php');</script>";
  }
    ...
    <section class="recruiter_list">
      ...
      <article class="recruiter_list_content">
        ...
        <div class="recruiter_list_content_nav">
          ...
          <a href="./recruiter_list.php" title="채용공고">채용공고</a>
        </div>
        <ul>
        ...
        <a href="/sub/recruiter_write_list.php" title="지원서 리스트 보기" class="list_view_link">지원서 리스트 보기</a>
        <?php } ?>
      </article>
    </section>
  </main>
