...
<div class="recruiter_top view">
  ...
  <?php if($_SESSION['ss_mb_id'] == "admin@hanmi.co.kr" && $row['recruiterChk'] == '0') {?>
  <a href="./recruiter_submit.php?idx=<?=$_GET['idx']?>&email=<?=$row['data_email']?>" title="채용하기" class="recruiter_submit_admin">채용하기</a>
  <?php } ?>
</div>
      ...
      <tr>
        ...
        <td>
          <label for="fileDoc" class="file_doc_label">
            ...
            ?>
            <div><a href="/sub/download.php?fileID=<?=$row['fileID']?>" title="<?=$row_file['nameOrigin']?>"><?=$row_file['nameOrigin']?></a></div>
          </label>
